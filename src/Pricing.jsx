...
const Pricing = () => {
  ...
  useEffect(() => {
    fetch('https://visa-ghor-server.vercel.app/slipPrices')
      .then(res => res.json())
      .then(json => {
        const sortedPricing = json.sort(
          (a, b) => parseInt(b.ksaRegular) - parseInt(a.ksaRegular) // Sort in descending order
        )
  ...
  let filChittagong = filteredPricing.filter(
    dhk => dhk.location === 'chittagong'
  )
  ...
  return (
    <div className='py-18'>
      <div className='py-12'>
        <h1 className='text-4xl md:text-5xl font-bold text-[#952895] text-center'>
          Full Auto Choice Slip Pricing
        </h1>
        <p className='text-md w-[60%] mt-3 text-[] mx-auto md:text-lg lg:text-xl font-bold text-center text-[#0b65b2]'>
          View and compare the prices of various medicals before making a
          choice.
        </p>
  ...
  <Marquee 
    ...
    pauseOnHover
  >
    দিন এর পেমেন্ট দিন এই পরিশোধ করতে হবে । <span className='mx-6'>যেকোনো প্রয়োজনে যোগাযোগ করুন +8801763666677</span>
  </Marquee>
</div>
        ...
        {loading ? (
          ...
          <div>
            ...
            {filDhaka.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#952895] text-center'>
                    Medical Centers in DHAKA
                  </h2>
                </div>
                    ...
                    <table className='min-w-full table-auto border-collapse border border-[#0b65b2]'>
                      <thead>
                        <tr className='bg-gradient-to-r from-[#0b64b2c7] to-[#952895] text-white'>
                          <th className='py-4 px-6 md:px-10 text-center text-xl border border-white'>
                            #SL
                          </th>
                          <th className='py-4 px-6 md:px-10 text-center text-xl border border-white'>
                            Medical Center Name
                      ...
                      <tbody>
                        {filDhaka.map((prices, index) => (
                          <tr key={index}>
                            ...
                            <td
                              className={`py-4 px-6 md:px-10 text-center border border-[#0b65b2] text-lg font-bold ${getColorForKSA(
                                prices?.ksaRegular
                              )}`}
                            >
                              {prices?.ksaRegular}/=
            ...
            {filChittagong.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#d41a1a]  text-center'>
                    Medical Centers in Chittagong
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
            ...
            {filSylhet.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#225c08] text-center'>
                    Medical Centers in Sylhet
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
            ...
            {filComilla.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#000000] text-center'>
                    Medical Centers in Comilla
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
            ...
            {filBarishal.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#6e4c18] text-center'>
                    Medical Centers in BARISHAL
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
            ...
            {filRajshahi.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#0b1235] text-center'>
                    Medical Centers in RAJSHAHI
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
            ...
            {filCox.length > 0 && (
              <div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] mx-auto overflow-x-auto'>
                  <h2 className='font-bold pb-1 text-2xl text-[#5f6417] text-center'>
                    Medical Centers in COX'S BAZAR
                  </h2>
                </div>
                <div className='w-[100%] md:w-[90%] lg:w-[80%] py-6 mx-auto overflow-x-auto'>
                  {loading ? (

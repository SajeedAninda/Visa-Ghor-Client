        ...
        <div className="bg">
            <div className='w-[80%] mx-auto h-screen py-28 lg:h-screen'>
                <div className='text-center'>
                    <h1 className='text-7xl md:text-8xl lg:text-9xl font-bold'><span className='text-[#952895]'>Other Services</span> <br /> <span>Will Be Available</span> <br /> <span className='text-[#0b65b2]'>Very Soon</span></h1>
                    <h3 className='mt-3'><em>Please Stay in Touch with us</em></h3>
